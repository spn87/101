...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th><?php echo JText::_( 'Tours Title' ); ?></th>
			...
			<th><?php echo JText::_( 'Gender' ); ?></th>
            		...
            		<th><?php echo JText::_( 'Mail' ); ?></th>
			<th><?php echo JText::_( 'Hotel' ); ?></th>
			<th><?php echo JText::_( 'Arrival Date' ); ?></th>
           		<th><?php echo JText::_( 'Departure Date' ); ?></th>
		</tr>
	</thead>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	
	{
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td><a href="<?php echo $link; ?>"><?php echo $row->tcode; ?></a></td>
           		<td><a href="<?php echo $link; ?>"><?php echo $row->fullname; ?></a></td>
            		<td><a href="<?php echo $link; ?>"><?php echo $row->address; ?></a></td>
			<td><a href="<?php echo $link; ?>"><?php echo $row->gender; ?></a></td>
			<td><a href="<?php echo $link; ?>"><?php echo $row->dob; ?></a></td>
			<td><a href="<?php echo $link; ?>"><?php echo $row->mail; ?></a></td>
			<td><a href="<?php echo $link;?>"><?php echo $row->hotel;?></a></td>
			<td><a href="<?php echo $link; ?>"><?php echo $row->arrivaldate; ?></a></td>
                        <td><a href="<?php echo $link; ?>"><?php echo $row->departuredate; ?></a></td>
